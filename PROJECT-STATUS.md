...
| teamMember | 2 | Live on about page, fetched from Sanity |
...
| blogPost | 0 | Fully dynamic via [slug].astro |
| book | 0 | Fully dynamic on /bookstore |
| siteSettings | 2 | phone, email, socials, siteName, tagline, description |
